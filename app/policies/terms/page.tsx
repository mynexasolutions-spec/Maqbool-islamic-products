...
export default function TermsPage() {
  return <PolicyDocument title="Terms & Conditions" summary="These terms explain the rules for using the Maqbool Islamic Products storefront, placing orders, and interacting with our services." sections={[
    ...
    { title: "Pricing and orders", paragraphs: ["Prices are displayed in the currency of your selected market. Tax and delivery charges are calculated using that market’s configured rules. An order is accepted only when we confirm it."], bullets: ["Coupons cannot be exchanged for cash.", "Only one eligible coupon may be used per order.", "Shipping, tax, and COD charges are shown before order placement.", "The current online-payment option is a simulation and does not collect or charge payment details."] },
