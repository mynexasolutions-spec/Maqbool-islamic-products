...
export default function PrivacyPage() {
  return <PolicyDocument title="Privacy Policy" summary="This policy describes the information used to provide your shopping experience, why it is needed, and the choices available to you." sections={[
    ...
    { title: "Storage and security", paragraphs: ["We use reasonable technical and organisational safeguards appropriate to the information processed. No internet service can promise absolute security. In this Part 1 demonstration, customer, address, cart, and order data are stored only in your browser local storage and can be cleared through browser settings."] },
