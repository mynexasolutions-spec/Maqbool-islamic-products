...
export default function ShippingPage() {
  return <PolicyDocument title="Shipping Policy" summary="This policy outlines order preparation, delivery estimates, shipping charges, and what to do when a parcel is delayed or damaged." sections={[
    ...
    { title: "Charges and free shipping", paragraphs: ["Shipping fees, free-shipping thresholds, delivery estimates, and COD charges vary by market and are shown before order placement. The delivery country must match the selected shopping market; Dubai orders are restricted to Dubai addresses."] },
